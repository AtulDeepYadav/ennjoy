...
function TermsAndConditions({ onNavClick }) {
  return (
    <>
      <div
      ...
      >
        ...
        >
          <div>
            <h2 className="fw-bold mb-3" style={{ color: '#0a174e', letterSpacing: '1px' }}>Terms and Conditions</h2>
            <div style={{ color: '#222', fontSize: '1.06rem', lineHeight: 1.7 }}>
              <p>These terms and conditions outline the rules and regulations for the use of {/*Comment for edit*/}ennjoy{/*Comment for edit*/}&#x27;s
                Website, located at {/*Comment for edit*/}https://www.ennjoy.in{/*Comment for edit*/}.</p>
              <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                {/*Comment for edit*/}https://www.ennjoy.in{/*Comment for edit*/} if you do not agree to take all of the terms and conditions stated
                on this page.</p>
              <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                to, prevailing law of Netherlands. Any use of the above terminology or other words in the singular,
                plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to
                same.</p>
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Cookies</h3>
              <p>We employ the use of cookies. By accessing {/*Comment for edit*/}https://www.ennjoy.in{/*Comment for edit*/}, you agreed to use
                cookies in agreement with the {/*Comment for edit*/}ennjoy{/*Comment for edit*/}&#x27;s Privacy Policy.{/*Comment for edit*/} </p>
              ...
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">License</h3>
              <p>Unless otherwise stated, {/*Comment for edit*/}ennjoy{/*Comment for edit*/} and/or its licensors own the intellectual property rights
                for all material on {/*Comment for edit*/}https://www.ennjoy.in{/*Comment for edit*/}. All intellectual property rights are
                reserved. You may access this from {/*Comment for edit*/}https://www.ennjoy.in{/*Comment for edit*/} for your own personal use
                subjected to restrictions set in these terms and conditions.</p>
              <p>You must not:</p>
              <ul>
                <li>Republish material from {/*Comment for edit*/}https://www.ennjoy.in</li>
                <li>Sell, rent or sub-license material from {/*Comment for edit*/}https://www.ennjoy.in</li>
                <li>Reproduce, duplicate or copy material from {/*Comment for edit*/}https://www.ennjoy.in</li>
                <li>Redistribute content from {/*Comment for edit*/}https://www.ennjoy.in</li>
              </ul>
              <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. {/*Comment for edit*/}ennjoy{/*Comment for edit*/}does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect the views and opinions
                of{/*Comment for edit*/}ennjoy{/*Comment for edit*/}, its agents and/or affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent permitted by applicable laws,
                {/*Comment for edit*/}ennjoy{/*Comment for edit*/} shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
                this website.</p>
              <p>ennjoy{/*Comment for edit*/} reserves the right to monitor all Comments and to remove any Comments which can be
              ...
              <p>You hereby grant {/*Comment for edit*/}ennjoy{/*Comment for edit*/} a non-exclusive license to use, reproduce, edit and authorize
                others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Hyperlinking to our Content</h3>
              ...
              <ul class="type-alpha">
                ...
                <li>the benefit to us from the visibility of the hyperlink compensates the absence of
                    {/*Comment for edit*/}ennjoy{/*Comment for edit*/}; and</li>
              ...
              <ul class="type-alpha">
                <li>is not in any way deceptive;</li>
                <li>does not falsely imply sponsorship, endorsement or approval of the linking party and its products or
                    services; and</li>
                <li>fits within the context of the linking party’s site.</li>
              </ul>
              <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to {/*Comment for edit*/}ennjoy{/*Comment for edit*/}. Please include your name,
              ...
              <p>No use of {/*Comment for edit*/}ennjoy{/*Comment for edit*/}&#x27;s logo or other artwork will be allowed for linking absent a
                trademark license agreement.</p>
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">iFrames</h3>
              ...
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Content Liability</h3>
              ...
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Your Privacy</h3>
              <p>Please read Privacy Policy</p>
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Reservation of Rights</h3>
              ...
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Removal of links from our website</h3>
              ...
              <h3 style={{ color: '#00bfff', fontWeight: 700 }} className="mb-3 mt-4">Disclaimer</h3>
              ...
              <ul className="type-alpha">
                ...
                <li>govern all liabilities arising under the disclaimer, including liabilities arising in contract, in
                    tort and for breach of statutory duty.</li>
              </ul>
